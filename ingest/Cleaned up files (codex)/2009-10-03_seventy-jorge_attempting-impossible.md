...
# === SOURCE & PROVENANCE ===
source_title: "Attempting the Impossible"
source_url: "https://www.churchofjesuschrist.org/study/general-conference/2009/10/attempting-the-impossible?lang=eng"
...
Immediately after teaching that "it is not requisite that a man should run faster than he has strength," King Benjamin indicated that "it is expedient that he should be diligent, that thereby he might win the prize." God will not require more than the best we can give because that would not be just, but neither can He accept less than that because that would not be just either. Therefore, let us always
