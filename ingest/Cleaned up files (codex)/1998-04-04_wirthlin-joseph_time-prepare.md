...
# === SOURCE & PROVENANCE ===
source_title: "The Time to Prepare"
source_url: "https://www.churchofjesuschrist.org/study/general-conference/1998/04/the-time-to-prepare?lang=eng"
...
The Savior has set the example for us and commands that "the works which [we] have seen [Him] do that shall [we] also do." I have always been impressed by Moroni's powerful
...
We can compare our lives with the flight of a spaceship. When its motor is started up, its trajectory is
...
We know that death is a necessary transition. It will come sooner or later to each of us. Our mortal bodies will return to earth, and our spirits will return to the spirit world. By virtue of the Savior's atoning sacrifice, we all will be resurrected. Each of us will stand before the judgment
