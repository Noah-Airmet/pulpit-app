...
# === SOURCE & PROVENANCE ===
source_title: "You Shall Receive the Spirit"
source_url: "https://www.churchofjesuschrist.org/study/general-conference/1973/10/you-shall-receive-the-spirit?lang=eng"
...
At one time 200 of them were so badly wounded that they fainted from the loss of blood. When they were carried from the battlefield, it was thought Alma 57:21: "Yea, and they did obey and observe to perform every word of command with exactness. …"
...
As we consider that question, the difference is immediately apparent. The difference is faith, and what is faith? Of course, there are many definitions of faith, but one definition is "a strong belief plus action." It is not perfect knowledge (as Alma explains in Alma 32), but real faith lets a man act as if
