...
# === SOURCE & PROVENANCE ===
source_title: "The Bishop and His Counselors"
source_url: "https://www.churchofjesuschrist.org/study/general-conference/1999/04/the-bishop-and-his-counselors?lang=eng"
...
A man is ordained a bishop, an set apart and given the keys to preside over a ward. He with his two counselors form a bishopric—a type of presidency.
...
Actually the Church is no bigger than a ward. Each bishop has counselors. He wears a special mantle and is designated as the presiding high priest in the ward. There are other high priests, and there is a presidency of elders. There are auxiliary leaders and teachers sufficient for
