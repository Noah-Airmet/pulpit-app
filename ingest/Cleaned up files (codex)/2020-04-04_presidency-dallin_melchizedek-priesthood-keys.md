...
# === SOURCE & PROVENANCE ===
source_title: "The Melchizedek Priesthood and the Keys"
source_url: "https://www.churchofjesuschrist.org/study/general-conference/2020/04/36oaks?lang=eng"
...
The principle that priesthood authority can be exercised only under the direction of the one who holds the keys for that function is fundamental in the Church, but this does not apply Church authorities teach family members but do not direct the exercise of priesthood authority in the family.
...
When we think of the fruits of the gospel and the restored Church of
